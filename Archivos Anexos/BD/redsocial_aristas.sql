...
CREATE TABLE `aristas` (
  `IDInicio` varchar(10) DEFAULT NULL,
  `IDFin` varchar(10) DEFAULT NULL,
  `Etiqueta` varchar(10) DEFAULT NULL,
  KEY `IDInicio` (`IDInicio`),
  KEY `IDFin` (`IDFin`),
  CONSTRAINT `ID` FOREIGN KEY (`IDFin`) REFERENCES `usuarios` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-11-16 10:09:27
